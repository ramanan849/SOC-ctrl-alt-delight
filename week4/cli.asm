...
; ------------------------------------------------------------------
	...
	niche_msg		db 'Hello there, I am Gokul. I finally got to print this text after a lot of trying, only after realizing at the end that I didnt build the OS after editing cli [dot] asm, HUH [exclamation mark]', 13, 10, 0
